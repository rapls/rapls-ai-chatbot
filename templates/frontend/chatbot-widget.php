...
<div id="wp-ai-chatbot" class="wp-ai-chatbot raplsaich-chatbot <?php echo esc_attr($theme_class); ?>" data-state="closed" data-position="<?php echo esc_attr($badge_position ?? 'bottom-right'); ?>">
    ...
    <div class="chatbot-window" role="dialog" aria-label="<?php esc_attr_e('Chat', 'rapls-ai-chatbot'); ?>" aria-hidden="true">
        ...
        <header class="chatbot-header">
            ...
            <button class="chatbot-new-conversation" aria-label="<?php esc_attr_e('Start a new conversation', 'rapls-ai-chatbot'); ?>" title="<?php esc_attr_e('Start a new conversation', 'rapls-ai-chatbot'); ?>">
                <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                    <path d="M12 4V1L8 5l4 4V6c3.31 0 6 2.69 6 6 0 1.01-.25 1.97-.7 2.8l1.46 1.46C19.54 15.03 20 13.57 20 12c0-4.42-3.58-8-8-8zm0 14c-3.31 0-6-2.69-6-6 0-1.01.25-1.97.7-2.8L5.24 7.74C4.46 8.97 4 10.43 4 12c0 4.42 3.58 8 8 8v3l4-4-4-4v3z"/>
                </svg>
            </button>
            <button class="chatbot-delete-history" aria-label="<?php esc_attr_e('Delete my chat history', 'rapls-ai-chatbot'); ?>" title="<?php esc_attr_e('Delete my chat history', 'rapls-ai-chatbot'); ?>" hidden>
                <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
